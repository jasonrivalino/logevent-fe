...
function EditPackageProduct() {
    ...
    const [selectedVendors, setSelectedVendors] = useState<number[]>([1, 2, 3]); // Pre-select vendors with IDs 1, 2, and 3
    ...
    return (
      <div className="px-6 pt-4 pb-6 bg-white rounded-xl shadow-md">
        {/* Text in center */}
        <h1 className="text-3xl font-bold mb-3 text-pink-900 font-sofia text-center">Edit Paket</h1>
        ...
        <form className="grid grid-cols-1 gap-4 font-sofia text-black">
            ...
            <div className="w-full">
              <div className="flex space-x-6">
                ...
                <div className="w-[30%]">
                  ...
                  <input className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-600" type="text" placeholder="Kapasitas" />
                </div>  
              </div>
              <div className="flex space-x-6">
          ...
          <div className="w-full">
            <button type="submit" className="w-full py-2 mt-2 bg-pink-600 text-white font-semibold rounded-lg hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-pink-600" onClick={() => router.push('/admin/manage-event-package')}>
              Edit Paket
            </button>
          </div>
        </form>
